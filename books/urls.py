...
from .views import yo,CreateUser, CreateAddress, searchByName, searchByGenre, sendCartInfo, addToCartInfo, addToWishlist, sendWishlistInfo, addToOrderedList, SendAllBooks 
urlpatterns = [
    path("",yo),
